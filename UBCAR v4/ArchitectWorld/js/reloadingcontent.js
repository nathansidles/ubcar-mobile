...
var ServerInformation = {
	POIDATA_SERVER: "http://sidl.es/testbed/wp/?ubcar_download_json",
...
var World = {
	...
	loadPoisFromJsonData: function loadPoisFromJsonDataFn(poiData) {
		...
		for (var currentPlaceNr = 0; currentPlaceNr < poiData.length; currentPlaceNr++) {
			var singlePoi = {
                ...
                "media": poiData[currentPlaceNr].media
			};
	...
	onMarkerSelected: function onMarkerSelectedFn(marker) {
        ...
        $("#poi-detail-media").html('');
        if( typeof marker.poiData.media != 'undefined' ) {
            for (var i = 0; i < marker.poiData.media.length; i++) {
                $("#poi-detail-media").append('<img width="100%" src="' + marker.poiData.media[i].url + '">');
            }
        }
